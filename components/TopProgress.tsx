...
export default function TopProgress() {
  ...
  return (
    <div aria-hidden>
      <div className={`fixed top-0 left-0 right-0 h-0.5 z-50 transition-opacity duration-200 ${active ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
        <div className="h-0.5 w-2/3 mx-auto rounded-full overflow-hidden">
          <div className={`h-full bg-gradient-to-r from-red-500 via-red-400 to-rose-500 animate-progress`}></div>
        </div>
      </div>
      <style>{`
        @keyframes progress {
